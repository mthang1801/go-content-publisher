...
run_cli settings-set enable_telegram_crawler false
run_cli settings-set enable_rewrite_processor true
run_cli settings-set auto_publish false
run_cli settings-set crawl_interval_seconds 300
run_cli settings-set process_interval_seconds 60
run_cli settings-set publish_interval_seconds 30
run_cli settings-set twitter_publish_interval_seconds 900
...
echo "Applied preset: twitter-only intake"
